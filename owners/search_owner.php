...
//search_owner.php - End-user form for searching an owner by the owner's ID Number

// Variable indicating the task value - to be used in determining the validation to be performed in client_validation.php
$task = 'search';
?>
<!DOCTYPE html>
<html>
